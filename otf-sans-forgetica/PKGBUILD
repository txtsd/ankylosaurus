...
package() {
  ...
  install -m644 "${srcdir}/Sans Forgetica/SansForgetica-Regular.otf" "${pkgdir}/usr/share/fonts/OTF/"
  install -Dm644 "${srcdir}/Sans Forgetica/The story of Sans Forgetica.pdf" -t "${pkgdir}/usr/share/doc/${pkgname}"
