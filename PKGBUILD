...
pkgver() {
  ...
  printf "${_majorver}.${_minorver}.${_securityver}.${_updatever}.r%s.g%s" "$(git rev-list --count e961b13cd68bc352b86af17c7e53df8537519beb..HEAD)" "$(git rev-parse --short=7 HEAD)"
}
